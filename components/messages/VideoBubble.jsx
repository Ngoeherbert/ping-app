...
export default function VideoBubble({ uri, caption, isMine = false, bleed = true }) {
    ...
    <View style={[styles.wrap, !bleed && styles.wrapFlush]}>
      <Pressable onPress={toggle} style={styles.videoWrap}>
        ...
        {(!ready || !playing) && !showFallback && (
          <View style={[styles.overlay, { backgroundColor: ready ? "rgba(0,0,0,0.15)" : "#1A1A1E" }]} pointerEvents="none">
